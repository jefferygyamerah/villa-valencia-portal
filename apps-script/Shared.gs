/**
 * Shared pure functions used by Code.gs and Reporting.gs.
 * Also tested via apps-script/code.testable.js in the Jest suite.
 *
 * Keep this file in sync with code.testable.js — they contain the
 * same functions. This .gs file is loaded by Apps Script; the .js
 * file is loaded by Jest.
 */
...
// No module.exports — Apps Script loads all .gs files in global scope.
